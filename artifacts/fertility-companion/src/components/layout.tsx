...
import {
  ...
  GraduationCap, CheckSquare, Heart, Palette, MapPin, Award, Flower2, BookMarked, Gauge, Users, Mail, Archive, Cloud, Flag, CalendarClock, FlaskConical, BrainCircuit, GitCompare,
} from "lucide-react";
